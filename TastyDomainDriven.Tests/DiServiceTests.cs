...
namespace TastyDomainDriven.Tests.DIService
{
    public sealed class DiServiceTests
    {
        ...
        public async Task TestDi()
        {
            ...
            await Assert.ThrowsAsync<MissingMethodException>(Execute);

            ClassActivatorService.InitializeActivator(new CustomClassActivator(services));

            await Execute();

            async Task Execute()
            {
                await handler.GetExecutor(
                        new SayCommand()
                        {
    ...
    internal class CustomClassActivator : IClassActivator
    {
        private IServiceProvider provider;

        public CustomClassActivator(IServiceProvider provider)
        {
